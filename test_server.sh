...
curl -X PUT -d "Hello, World!" http://localhost:9001/file/test-file
echo ""

# Test 2: Get the file back
echo "Test 2: Getting file back..."
curl -X GET http://localhost:9001/file/test-file
echo ""

# Test 3: Generate public URL
echo "Test 3: Generating public URL..."
curl -X POST -H "Content-Type: application/json" -d '{"duration": 5}' http://localhost:9001/file/test-file/public-url
echo ""
